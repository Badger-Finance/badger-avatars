...
abstract contract ConvexConstants {
    ...
    IUniswapRouterV3 internal constant UNIV3_ROUTER =
        IUniswapRouterV3(0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45);
    ICurvePool internal constant CRV_ETH_CURVE_POOL =
        ICurvePool(0x8301AE4fc9c624d1D396cbDAa1ed877821D7C511);
    ICurvePool internal constant CVX_ETH_CURVE_POOL =
        ICurvePool(0xB576491F1E6e5E62f1d8F26062Ee822B40B0E0d4);
    IFraxSwapRouter internal constant FRAXSWAP_ROUTER =
        IFraxSwapRouter(0xC14d550632db8592D1243Edc8B95b0Ad06703867);
    ...
    IAggregatorV3 internal constant FXS_USD_FEED =
        IAggregatorV3(0x6Ebc52C8C1089be9eB3945C4350B68B8E4C2233f);
    IAggregatorV3 internal constant CRV_USD_FEED =
        IAggregatorV3(0xCd627aA160A6fA45Eb793D19Ef54f5062F20f33f);
    IAggregatorV3 internal constant CVX_USD_FEED =
        IAggregatorV3(0xd962fC30A72A84cE50161031391756Bf2876Af5D);
    IAggregatorV3 internal constant CRV_ETH_FEED =
