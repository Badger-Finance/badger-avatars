...
contract ConvexAvatarUtils is ConvexConstants {
    ...
    // INTERNAL VIEW
    ////////////////////////////////////////////////////////////////////////////
    function getFxsAmountInUsdc(uint256 _fxsAmount)
        internal
        view
    ...
    function getCrvAmountInUsdc(uint256 _crvAmount)
        internal
        view
        returns (uint256 usdcAmount_)
    {
    ...
    function getCrvAmountInEth(uint256 _crvAmount)
        internal
        view
        returns (uint256 usdcAmount_)
    {
    ...
    function getCvxAmountInUsdc(uint256 _cvxAmount)
        internal
        view
        returns (uint256 usdcAmount_)
    {
    ...
    function fetchPriceFromClFeed(IAggregatorV3 _feed)
        internal
        view
